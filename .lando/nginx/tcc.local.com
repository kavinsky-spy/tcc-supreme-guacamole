server {
    ...
    # 418 I'm a teapot - random code for the purpose of serving the old feed
    # https://www.topdeck.travel/?option=com_zenholidays&view=search&format=json&key=1de32cea-0e10-4f2f-a69d-446d1863aa73
    error_page 418 = @feed;
    if ($arg_option = "com_zenholidays") {
        return 418;
    }
    location @feed {
        proxy_pass https://52.212.115.228;
        proxy_set_header Host www.quality.org;
